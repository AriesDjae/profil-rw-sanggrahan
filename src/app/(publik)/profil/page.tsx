...
export default async function HalamanProfil() {
  ...
  return (
    <>
      <section className="motif-hero text-white">
        <div className="mx-auto max-w-5xl px-4 py-16 text-center">
          ...
          <p className="mt-4 text-brand-100">{pengaturan.tagline}</p>
          <dl className="mx-auto mt-10 grid max-w-3xl grid-cols-2 gap-3 sm:grid-cols-4">
            {[
              ...
              <div key={s.l} className="rounded-2xl border border-white/15 bg-white/10 p-4">
                <dd className="text-2xl font-bold tabular-nums">{s.v}</dd>
                <dt className="mt-1 text-[11px] font-medium text-brand-100">{s.l}</dt>
              </div>
            ))}
          </dl>
        </div>
